...
let theCapital = statesAndCapitals[state]

if let theCapital = theCapital {
 ...
 */
var bandMembers = ["Nirvana": ["Kurt Cobain", "Krist Novoselic", "Dave Grohl"],
    "The Beatles": ["John Lennon", "George Harrison", "Paul McCartney", "Ringo Starr"],
    "The Breeders": ["Kim Deal", "Kelley Deal", "Josephine Wiggs", "Jim Macpherson"],
    "Pixies": ["Frank Black", "Joey Santiago", "Kim Deal", "David Lovering"]]
...
//[String : Array<String>] or [String : [String]]
...
let membersInGroup = bandMembers[bandName]

if let membersInGroup = membersInGroup {
    
    print("The members of \(bandName) are \(membersInGroup)")
    
} else {
    
    print("I don't know \(bandName)'s members")
}
